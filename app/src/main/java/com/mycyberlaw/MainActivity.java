...
public class MainActivity extends AppCompatActivity implements
        ...
        MindmapFragment.OnFragmentInteractionListener,
    ...
    private static final String TAG_MINDMAP = "mindmap";
    private static final String TAG_VIDEO = "video";
    private static final String TAG_MESSAGES = "messages";
    public static String CURRENT_TAG = TAG_NOTES;
    private Handler mHandler;
    private boolean shouldLoadNotesFragOnBackPress = true;
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_notes:
                        ...
                        CURRENT_TAG = TAG_NOTES;
                        break;
                    case R.id.nav_mindmap:
                        navItemIndex = 1;
                        CURRENT_TAG = TAG_MINDMAP;
                        break;
                    case R.id.nav_video:
                        navItemIndex = 2;
    ...
    public void onBackPressed() {
        ...
        if (shouldLoadNotesFragOnBackPress) {
